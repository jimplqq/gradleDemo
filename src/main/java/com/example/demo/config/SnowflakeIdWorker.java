...
public class SnowflakeIdWorker {
  ...
  public static long getId() {
    SnowflakeIdWorker snowflakeIdWorker = SnowflakeIdWorkerSingleton.getSnowflakeIdWorker();

    return snowflakeIdWorker.nextId();
  }

  @Singleton
  public static class SnowflakeIdWorkerSingleton {
    ...
    public static SnowflakeIdWorker getSnowflakeIdWorker() {
      if (snowflakeIdWorker == null) {
        synchronized (SnowflakeIdWorkerSingleton.class) {
          if (snowflakeIdWorker == null) {
